...
function App() {
  ...
  return (
    <div className="relative min-h-screen w-full text-white font-sans selection:bg-fuchsia-500/30 selection:text-white overflow-x-hidden">
      ...
      <div className="fixed inset-0 z-5 pointer-events-none">
        <div className="absolute top-20 left-20 w-96 h-96 bg-fuchsia-500/20 rounded-full blur-[100px] animate-pulse-slow" />
        <div className="absolute bottom-20 right-20 w-96 h-96 bg-cyan-500/20 rounded-full blur-[100px] animate-pulse-slow" style={{ animationDelay: '2s' }} />
      </div>
      
      {/* Main Content Container */}
      <div className="relative z-20">
        {/* Navbar */}
      <nav className="sticky top-0 z-40 bg-black/30 backdrop-blur-2xl border-b border-white/10 px-8 py-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-2 group cursor-pointer">
            <div className="bg-gradient-to-br from-fuchsia-500 to-cyan-500 p-2 rounded-xl group-hover:rotate-12 transition-transform shadow-lg shadow-fuchsia-500/30">
              <Zap className="w-6 h-6 text-white" />
            </div>
            <span className="text-2xl font-black tracking-tighter text-white drop-shadow-md">ACE IQ</span>
          </div>
          <div className="hidden md:flex items-center gap-10 text-sm font-bold text-white/70">
            ...
            <Button 
              ...
              className="bg-gradient-to-r from-fuchsia-500 to-cyan-500 text-white hover:opacity-90 border-0"
            >
              Demo
            </Button>
          </div>
      ...
      <section className="relative px-8 pt-32 pb-32 overflow-hidden min-h-screen flex items-center">
        ...
        <div className="max-w-6xl mx-auto text-center relative z-30">
          <motion.div 
            ...
            className="inline-flex items-center gap-2 bg-white/10 border border-white/20 text-white px-4 py-2 rounded-full text-xs font-black mb-8 uppercase tracking-widest backdrop-blur-md"
          >
          ...
          <motion.h1 
            ...
            className="text-6xl md:text-8xl font-black mb-8 tracking-tighter text-white leading-[0.9] drop-shadow-2xl"
          >
            The Future of <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-fuchsia-400 via-cyan-400 to-fuchsia-400 bg-300% animate-gradient">College Events.</span>
          </motion.h1>
          ...
          <motion.p 
            ...
            className="text-xl text-white/80 mb-12 max-w-2xl mx-auto font-medium leading-relaxed drop-shadow-lg"
          >
          ...
          >
            <div className="relative w-full sm:w-[450px]">
              ...
              <input 
                ...
                className="w-full pl-14 pr-6 py-5 rounded-2xl border border-white/20 focus:outline-none focus:ring-4 focus:ring-fuchsia-500/20 bg-white/10 backdrop-blur-md shadow-2xl text-white text-lg font-medium transition-all"
              />
            </div>
            <Button 
              size="lg" 
              onClick={() => setShowQuiz(true)} 
              className="w-full sm:w-auto rounded-2xl gap-2 h-[68px] bg-gradient-to-r from-fuchsia-500 to-cyan-500 border-0 hover:opacity-90"
            >
      ...
      <section id="mission" className="px-8 py-20 text-white overflow-hidden relative">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-12">
          <div className="bg-gradient-to-br from-fuchsia-500/20 to-cyan-500/20 p-8 rounded-[40px] border border-white/20 backdrop-blur-2xl md:w-1/3 text-center">
            <div className="text-fuchsia-300 font-black uppercase tracking-[0.2em] text-xs mb-2">Domain 3</div>
            <h4 className="text-2xl font-black mb-4">EdTech Solutions</h4>
            <div className="h-1 w-12 bg-gradient-to-r from-fuchsia-500 to-cyan-500 mx-auto rounded-full mb-4" />
            <p className="text-sm text-white/70 font-medium leading-relaxed">
              ECLearnix 360° 4.0 Innovation Challenge <br /> Round 2 Presentation
            </p>
          </div>
          <div className="md:w-2/3">
            <h3 className="text-3xl font-black mb-6 tracking-tight text-white">The Mission: Project ACE IQ</h3>
      ...
      <section id="impact" className="px-8 py-32 text-white overflow-hidden relative">
        <div className="absolute top-0 right-0 w-1/2 h-full bg-gradient-to-l from-fuchsia-500/10 to-transparent skew-x-12 translate-x-1/2" />
        <div className="max-w-6xl mx-auto relative">
          <div className="flex flex-col md:flex-row items-center gap-16">
            <div className="md:w-1/2">
              <h2 className="text-sm font-black text-fuchsia-300 uppercase tracking-[0.3em] mb-4">The Result</h2>
              <h3 className="text-5xl font-black tracking-tighter mb-8 leading-tight text-white">Measurable <br />Business Impact.</h3>
              <p className="text-lg text-white/70 font-medium mb-12">
              ...
              <div className="space-y-6">
                {[
                  ...
                  <div key={i} className="flex items-center gap-4 bg-white/10 p-4 rounded-2xl border border-white/20 backdrop-blur-md">
                    <div className="bg-gradient-to-br from-fuchsia-500 to-cyan-500 text-white p-2 rounded-xl shadow-lg">
                      {item.icon}
                    </div>
            ...
            <div className="md:w-1/2 grid grid-cols-2 gap-6">
              {[
                ...
                <Card key={i} className="p-8 bg-white/10 border-0 border-none shadow-2xl backdrop-blur-xl flex flex-col items-center text-center group hover:scale-105 transition-transform">
                  <div className="text-4xl font-black bg-gradient-to-r from-fuchsia-400 to-cyan-400 bg-clip-text text-transparent mb-2">{stat.val}</div>
                  <div className="text-[10px] font-black text-white/50 uppercase tracking-widest mb-4">{stat.label}</div>
                  <p className="text-xs text-white/70 font-bold">{stat.desc}</p>
                </Card>
              ))}
            </div>
            </div>
      ...
      {/* Live Audit Section */}
      <section id="audit" className="px-8 py-20 border-y border-white/10">
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row gap-12 items-center">
            <div className="flex-1">
              <div className="inline-flex items-center gap-2 bg-rose-500/20 text-rose-300 px-3 py-1 rounded-full text-[10px] font-black mb-6 border border-rose-500/30 uppercase tracking-widest">
                <AlertTriangle className="w-3 h-3" />
                Live Audit Results
              </div>
              <h2 className="text-4xl font-black mb-6 tracking-tight text-white">The Cold-Start Content Crisis</h2>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {auditGaps.map((gap, i) => (
                  <Card key={i} className="p-4 border-white/20 bg-white/10 backdrop-blur-md">
                    <h4 className="font-bold text-sm mb-1 text-white">{gap.title}</h4>
                    <p className="text-xs text-white/60 leading-normal">{gap.desc}</p>
                  </Card>
                ))}
              </div>
            </div>
            <div className="flex-1 w-full">
              <div className="bg-black/40 rounded-3xl p-8 shadow-2xl relative overflow-hidden group border border-white/10 backdrop-blur-md">
                ...
                <div className="space-y-4 font-mono text-xs">
                  ...
                  <div className="text-white/50">Scanning AllCollegeEvent.com...</div>
                  <div className="flex gap-4 items-center py-2 border-y border-white/10">
                  ...
                  <div className="space-y-1">
                    <div className="text-white/50">[WARN] 0 events found in catalog.</div>
                    <div className="text-white/50">[WARN] Chatbot response latency: N/A (No logic).</div>
                    <div className="text-white/50">[WARN] Session personalization: 0%</div>
                  </div>
                  <div className="pt-2 text-fuchsia-400">ACE IQ Injection Recommended.</div>
                </div>
              </div>
            </div>
          </div>
              ...
              {showQuiz ? (
                <div className="flex flex-col items-center">
                  <div className="mb-12 text-center">
                    <h2 className="text-4xl font-black mb-4 tracking-tight text-white">Personalise Your Session</h2>
                    <p className="text-white/70 font-medium">Our AI needs 30 seconds to match 500+ events to your career goals.</p>
                  </div>
                ...
                >
                  <div className="flex flex-col md:flex-row items-end justify-between mb-12 gap-6">
                    <div>
                      ...
                      <h2 className="text-5xl font-black tracking-tight text-white">
                        ...
                        <span className="text-white/50">in {userProfile.city}</span>
                      </h2>
                    </div>
                    <Button variant="outline" className="border-white/30 text-white hover:bg-white/10" onClick={() => setShowQuiz(true)}>
                      Refine Profile
                    </Button>
                  </div>
                  ...
                  {loading ? (
                    <div className="flex items-center justify-center h-64">
                      <div className="text-white/50 font-bold">Loading matched events...</div>
                    </div>
                  ) : (
      ...
      <section id="features" className="px-8 py-32">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-20">
            <h2 className="text-sm font-black text-fuchsia-300 uppercase tracking-[0.3em] mb-4">Core Intelligence</h2>
            <h3 className="text-5xl font-black tracking-tighter text-white">The 5 Pillars of ACE IQ</h3>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
              ...
              {pillars.map((pillar, index) => (
                <button
                  ...
                  className={cn(
                    ...
                    activePillar === index 
                      ? 'bg-white/80 text-slate-900 shadow-2xl shadow-fuchsia-500/20 border border-fuchsia-500/30' 
            ...
            <Card className="lg:col-span-8 p-12 bg-white/80 backdrop-blur-xl border-white/30 min-h-[400px] flex flex-col justify-center">
              ...
              >
                ...
                <h3 className="text-4xl font-black mb-6 tracking-tight text-slate-900">{pillars[activePillar].title}</h3>
                <p className="text-xl text-slate-600 font-medium leading-relaxed mb-10 max-w-xl">
                  {pillars[activePillar].description}
                </p>
                <div className="flex items-center gap-6">
                  <div className="flex flex-col">
                    <span className="text-3xl font-black bg-gradient-to-r from-fuchsia-600 to-cyan-600 bg-clip-text text-transparent">
      ...
      <section id="roadmap" className="px-8 py-32 overflow-hidden">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-20">
            <h2 className="text-sm font-black text-fuchsia-300 uppercase tracking-[0.3em] mb-4">Implementation</h2>
            <h3 className="text-5xl font-black tracking-tighter text-white">3-Phase Roadmap</h3>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
            ...
            {roadmap.map((phase, i) => (
              ...
              >
                <Card className="p-8 h-full border-white/30 relative bg-white/80 backdrop-blur-xl group hover:border-fuchsia-500 transition-colors">
                  <div className="bg-gradient-to-r from-fuchsia-500 to-cyan-500 text-white text-[10px] font-black px-3 py-1 rounded-full absolute -top-3 left-8 uppercase tracking-widest shadow-lg">
                    {phase.phase}
                  </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col lg:flex-row gap-20 items-center">
            <div className="lg:w-1/2">
              <h2 className="text-sm font-black text-fuchsia-300 uppercase tracking-[0.3em] mb-4">System Architecture</h2>
              <h3 className="text-5xl font-black tracking-tighter text-white mb-8 leading-[0.9]">Built for <br />Scalability.</h3>
              <p className="text-lg text-white/70 font-medium mb-12">
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="space-y-2">
                  <div className="text-[10px] font-black text-white/60 uppercase tracking-widest">Core Stack</div>
                ...
                <div className="space-y-2">
                  <div className="text-[10px] font-black text-white/60 uppercase tracking-widest">AI Tools</div>
                  <div className="flex flex-wrap gap-2">
                    {['spaCy', 'Tesseract', 'Scikit-learn', 'TensorFlow'].map(tech => (
                      <span key={tech} className="bg-fuchsia-500/20 text-fuchsia-300 px-3 py-1 rounded-lg text-xs font-bold border border-fuchsia-500/30 backdrop-blur-md">{tech}</span>
                    ))}
                  </div>
                </div>
              </div>
            ...
            <div className="lg:w-1/2 w-full grid grid-cols-1 gap-4">
              {[
                ...
                <Card key={i} className="p-6 border-white/30 bg-white/80 backdrop-blur-xl flex items-center gap-6 group hover:shadow-xl transition-all">
                  <div className="bg-gradient-to-br from-fuchsia-500 to-cyan-500 text-white p-3 rounded-2xl group-hover:scale-110 transition-transform shadow-lg">
                    {layer.icon}
                  </div>
                  <div>
      ...
      <section id="team" className="px-8 py-32 text-white relative overflow-hidden">
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row items-end justify-between mb-20 gap-8">
            <div>
              <h2 className="text-sm font-black text-fuchsia-300 uppercase tracking-[0.3em] mb-4">The Innovators</h2>
              <h3 className="text-6xl font-black tracking-tighter">Team Alpha's</h3>
            </div>
            <div className="text-right">
              <div className="text-fuchsia-300 font-black text-lg">Domain 3</div>
              <div className="text-white/60 font-medium">EdTech Solutions</div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {teamMembers.map((member, i) => (
              ...
              >
                <div className="p-8 rounded-3xl bg-white/10 border border-white/20 hover:border-fuchsia-500 transition-colors group backdrop-blur-md">
                  <div className="w-12 h-12 rounded-2xl bg-white/10 flex items-center justify-center mb-6 text-fuchsia-300 group-hover:bg-gradient-to-br group-hover:from-fuchsia-500 group-hover:to-cyan-500 group-hover:text-white transition-all shadow-lg">
                    <Users className="w-6 h-6" />
                  </div>
                  <h4 className="text-xl font-black mb-1 group-hover:text-fuchsia-300 transition-colors">{member.name}</h4>
                  <div className="text-fuchsia-300 font-bold text-xs uppercase tracking-widest mb-4">{member.role}</div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-start gap-12 mb-20">
            <div className="max-w-xs">
              <div className="flex items-center gap-2 mb-6">
                <div className="bg-gradient-to-br from-fuchsia-500 to-cyan-500 p-1.5 rounded-lg">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-20">
              <div className="space-y-4">
                <h4 className="font-black text-xs uppercase tracking-widest text-white/50">Platform</h4>
                <ul className="text-sm font-bold text-white/70 space-y-2">
                  <li className="hover:text-fuchsia-300 cursor-pointer transition-colors">Events Feed</li>
                  <li className="hover:text-fuchsia-300 cursor-pointer transition-colors">Organizer Portal</li>
                  <li className="hover:text-fuchsia-300 cursor-pointer transition-colors">Leaderboards</li>
                </ul>
              </div>
              <div className="space-y-4">
                <h4 className="font-black text-xs uppercase tracking-widest text-white/50">Team Alpha's</h4>
                <ul className="text-sm font-bold text-white/70 space-y-2">
                  <li className="hover:text-fuchsia-300 cursor-pointer transition-colors">About Us</li>
                  <li className="hover:text-fuchsia-300 cursor-pointer transition-colors">Hackathon 360</li>
                  <li className="hover:text-fuchsia-300 cursor-pointer transition-colors">Documentation</li>
                </ul>
              </div>
            </div>
          </div>
          <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-6">
            <p className="text-xs font-bold text-white/40 uppercase tracking-widest">© 2026 Team Alpha's | Narnarayan Shastri Institute of Technology, Ahmedabad</p>
            <div className="flex items-center gap-6">
              <Github className="w-5 h-5 text-white/40 hover:text-fuchsia-300 cursor-pointer transition-colors" />
              <div className="bg-white/10 text-white px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-tighter border border-white/20">
